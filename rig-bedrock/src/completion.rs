use crate::{client::Client, document_to_json, json_to_document, types::from_message};
use aws_sdk_bedrockruntime::{
    operation::converse::ConverseError,
    types::{
        ContentBlock, ConverseOutput, InferenceConfiguration, SystemContentBlock, Tool,
